        ...
        return (
            <main className="w-screen h-screen overflow-auto">
                <Modal
                    ...
                    title="Thank you!"
                >
                    Don't know backend yet but when I do... I'll learn how to
                    send this lmao <br />
                ...
                <section className="w-full h-full flex flex-row flex-wrap justify-center">
                    ...
                    <div className="h-2/6 w-11/12 mt-5 mb-5 border-solid border-2 rounded-lg border-stone-300 shadow-lg flex items-center justify-center">
                        <div>
                    ...
                    <Button
                        ...
                        className="bg-stone-200 shadow-md text-black w-full rounded-md text-center"
                    >
                        Order
                    </Button>
                </section>
